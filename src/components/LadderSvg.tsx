const LadderSvg = () => {
  return <svg viewBox="0 0 300 400" xmlns="http://www.w3.org/2000/svg" className="w-full h-full my-0 px-0 mx-0 py-0">
      <defs>
      ...
      {[50, 100, 150, 200, 250, 300, 350].map(y => <path key={y} d={`M60 ${y} C60 ${y - 3}, 65 ${y - 4}, 70 ${y - 1} L230 ${y - 1} C235 ${y - 4}, 240 ${y - 3}, 240 ${y} C240 ${y + 4}, 235 ${y + 6}, 230 ${y + 3} L70 ${y + 3} C65 ${y + 6}, 60 ${y + 4}, 60 ${y} Z`} fill="#FF7F6B" />)}
      ...
      {[50, 100, 150, 200, 250, 300, 350].map(y => <g key={`nails-${y}`}>
